...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Your message has been sent to my moderators!\nI provide movies & series in Groups only.\n Add me to your group to get your required movies & series</b>",reply_markup=InlineKeyboardMarkup(inline_keyboard=[[types.InlineKeyboardButton(text="⚡𝘼𝘿𝘿 𝙈𝙀 𝙏𝙊 𝙔𝙊𝙐𝙍 𝙂𝙍𝙊𝙐𝙋⚡", url="http://t.me/cc_multi_bot?startgroup=true")]]))
