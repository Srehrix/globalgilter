...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>Your message has been sent to my moderators!\nI provide movies & series in Groups only.\n Add me to your group to get your required movies & series</b>",reply_markup=InlineKeyboardMarkup(inline_keyboard=[[InlineKeyboardButton(text="⚡𝘼𝘿𝘿 𝙈𝙀 𝙏𝙊 𝙔𝙊𝙐𝙍 𝙂𝙍𝙊𝙐𝙋⚡", url="http://t.me/cc_multi_bot?startgroup=true")]]))
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('ᴏᴡɴ ɪɴғᴏ', url='https://t.me/Tiyaan_bots')
        ], [
            InlineKeyboardButton('ʜᴇʟᴘ', callback_data='help'),
            InlineKeyboardButton('ᴀʙᴏᴜᴛ', callback_data='about')
         ],[  
            InlineKeyboardButton('ʜᴏᴡ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ', callback_data='https://t.me/CinemaCompanyDiscussion/5557')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        ...
        buttons = [[
            InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/Tiyaan_bots'),
        ...
        buttons = [[
           InlineKeyboardButton('ʀᴇᴘᴏ', url='https://t.me/Tiyaan_bots'),
           InlineKeyboardButton('ᴏᴡɴᴇʀ', url='https://t.me/Tiyaan_bots')
        ], [
            InlineKeyboardButton('ʙᴀᴄᴋ', callback_data='aswin')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
