...
def song(client, message):
    ...
    try:
        ...
        performer = f"[ѕн - @CinemaCompanyofficials]" 
    ...
    try:
        ...
        rep = '**𝚂𝚄𝙱𝚂𝙲𝚁𝙸𝙱𝙴 ›› [🍁 ᴄʜᴀɴɴᴇʟ 🍁](https://t.me/CinemaCompanyUpdates)**\n**𝙿𝙾𝚆𝙴𝚁𝙴𝙳 𝙱𝚈 ›› [ᴛɪʏᴀᴀɴ ʙᴏᴛꜱ](https://t.me/Tiyaan_bots)**\n@𝑪𝒊𝒏𝒆𝒎𝒂𝑪𝒐𝒎𝒑𝒂𝒏𝒚𝒐𝒇𝒇𝒊𝒄𝒊𝒂𝒍𝒔**'
